...
class Application (fix.Application):
    ...
    def fillSnapShot(self):
        ...
        f = file(home_path, "w")
        f.write(
            '''symbol, entryid, updateaction, entrytype, price, size, minqty, mininc, minbr, ytm, ytw\n''')
        lst = list()
    ...
    def queryEnterOrder(self):
        ...
        trade.setField(fix.TradeDate((datetime.now().strftime("%Y%m%d")))
                       )                      # 75
        ...
        group.setField(fix.PartyIDSource(
